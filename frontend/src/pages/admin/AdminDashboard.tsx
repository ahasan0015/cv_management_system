          ...
          <div className="p-3 border-top">
            <div className="card border-0 bg-primary-subtle">
              <div className="card-body">
                ...
                <p className="small text-muted mb-2">Everything is running smoothly today.</p>
                <button className="btn btn-outline-primary btn-sm">View Logs</button>
              </div>
            </div>
          </div>
        </aside>

        <div className="offcanvas offcanvas-start" tabIndex={-1} id="adminSidebar" aria-labelledby="adminSidebarLabel">
          <div className="offcanvas-header border-bottom">
            <h5 className="offcanvas-title fw-bold" id="adminSidebarLabel">Admin Menu</h5>
                ...
                <div className="col-12 col-sm-6 col-xl-3" key={item.title}>
                  <div className="card border-0 shadow-sm h-100">
                    <div className="card-body">
                      ...
                      <small className="text-muted">{item.change} this month</small>
                    </div>
                  </div>
                </div>
              ))}
                        ...
                        <tbody>
                          {recentUsers.map((userItem) => (
                            <tr key={userItem.name}>
                              ...
                              <td>{userItem.role}</td>
                              <td>
                                <span className={`badge ${userItem.status === "Active" ? "bg-success-subtle text-success" : "bg-warning-subtle text-warning"}`}>
                                  {userItem.status}
                                </span>
                              </td>
                              <td>
                ...
                <div className="card border-0 shadow-sm mb-4">
                  <div className="card-body">
                    ...
                    {quickActions.map((item) => (
                      <button key={item.label} className="btn btn-primary w-100 mb-2 d-flex align-items-center justify-content-center gap-2">
                ...
                <div className="card border-0 shadow-sm">
                  <div className="card-body">
                    ...
                    <ul className="list-unstyled mb-0">
                      <li className="d-flex justify-content-between py-2 border-bottom"><span>New CV uploads</span><strong>120</strong></li>
                      <li className="d-flex justify-content-between py-2 border-bottom"><span>Pending approvals</span><strong>8</strong></li>
                      <li className="d-flex justify-content-between py-2"><span>Support tickets</span><strong>5</strong></li>
                    </ul>
                  </div>
                </div>
              </div>
